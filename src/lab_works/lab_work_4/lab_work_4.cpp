...
namespace M3D_ISICG
{
	...
	bool LabWork4::init()
	{
		...
		//_bunny.load( "bunny", "./bunny/bunny.obj" );
		_bunny.load( "bunny", "./conference/conference.obj" );
		float scale				= 0.01;
		_bunny._transformation = glm::scale( _bunny._transformation, glm::vec3( scale, scale, scale ) );
