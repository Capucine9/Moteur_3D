...
namespace M3D_ISICG
{
	...
	void TriangleMesh::render( const GLuint p_glProgram ) const
	{
		...
		glProgramUniform3fv( p_glProgram,
							 glGetUniformLocation( p_glProgram, "ambiant_color" ),
							 1,
							 glm::value_ptr( _material._ambient ) );
		glProgramUniform1i(p_glProgram, 
							 glGetUniformLocation( p_glProgram, "uHasAmbientMap" ), 
							 _material._hasAmbientMap );

		// Eclairage diffus
		glProgramUniform3fv( p_glProgram,
							 glGetUniformLocation( p_glProgram, "diffuse_color" ),
							 1,
		...
		glProgramUniform3fv( p_glProgram,
							 glGetUniformLocation( p_glProgram, "specular_color" ),
							 1,
		...
		glProgramUniform1f(p_glProgram, 
							 glGetUniformLocation( p_glProgram, "shininess" ), 
